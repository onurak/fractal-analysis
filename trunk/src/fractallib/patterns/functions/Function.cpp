...
void Function::defineArg(const std::string &argName, GVariant defaultValue)
{
    //int argId = IDGenerator::idOf(argName);
    //m_definedArgs[argId] = m_options[argId] = defaultValue;
}

void Function::parseArgs(FunctionArgs& args)
{
//    std::map<int, GVariant>::iterator i;
